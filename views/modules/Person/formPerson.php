...
<div class="card-body">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required type="text" minlength="6" maxlength="11" class="form-control" id="documentPerson" name="documentPerson" placeholder="Ingrese su documento">
                </div>
            </div>
            <!--Nombre del docente-->
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required type="text" maxlength="130" class="form-control" id="namePerson" name="namePerson" placeholder="Ingresa los nombres">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required type="text" maxlength="130" class="form-control" id="lastNamePerson" name="lastNamePerson" placeholder="Ingresa los Apellidos">
                </div>
            </div>
            <!--RH del docente-->
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required type="text" minlength="6"  maxlength="10" class="form-control" id="phonePerson" name="phonePerson" placeholder="Ingrese su telefono">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required type="text" maxlength="250" class="form-control" id="adressPerson" name="adressPerson" placeholder="Ingrese su direccion">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <input required type="email" maxlength="90" class="form-control" id="emailPerson" name="emailPerson" placeholder="Ingrese su Correo Electronico">
                </div>
            </div>
            <!--Genero del Docente-->
            <div class="form-group row">
