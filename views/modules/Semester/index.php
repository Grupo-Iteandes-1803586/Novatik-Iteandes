        ...
        <section class="content">
                ...
                <?php if ($_GET['respuesta'] == "correcto"){ ?>
                    <div class="alert alert-success alert-dismissible">
                        ...
                        <?php }else if($_GET['action'] == "update"){ ?>
                            Los datos del Semestre han sido actualizados correctamente!
                        <?php } ?>
                    </div>
                <?php } ?>
            <?php } ?>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        <div class="col">
                            <table id="tblSemestre" class="datatable table table-bordered table-striped">
                                <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Nombre</th>
                                    <th>Descripcion</th>
                                    <th>Fecha Inicio Semestre</th>
                                    <th>Fecha Fin Semestre</th>
                                    <th>Fecha Inicio 1er corte </th>
                                    <th>Fecha fin 1er corte</th>
                                ...
                                <tbody>
                                <?php
                                $arrSemestres = SemesterControllers::getAll();
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <?php if ($semestre->getStatuSemester() != "Activo"){ ?>
                                                <a href="../../../app/Controllers/SemesterControllers.php?action=active&idSemester=<?php echo $semestre->getIdSemester(); ?>" type="button" data-toggle="tooltip" title="Activar" class="btn docs-tooltip btn-success btn-xs"><i class="fa fa-check-square"></i></a>
                                            <?php }else{ ?>
