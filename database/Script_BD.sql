...
-- Schema iteandes_novatik
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `iteandes_novatik` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
...
CREATE TABLE IF NOT EXISTS `iteandes_novatik`.`Lenguages` (
  `idLenguages` TINYINT UNSIGNED NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `iteandes_novatik`.`TeacherLenguages` (
  ...
  `Lenguages_idLenguages` TINYINT UNSIGNED NOT NULL,
