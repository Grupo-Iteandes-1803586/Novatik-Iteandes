...
-- Tiempo de generación: 30-07-2020 a las 22:22:05
...
--
ALTER TABLE `experience`
  MODIFY `idExperience` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `person`
  MODIFY `idPerson` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;
...
--
ALTER TABLE `student`
  MODIFY `idStudent` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `trainingcompetition`
  MODIFY `idTrainingCompetition` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `trainingprogram`
--
ALTER TABLE `trainingprogram`
  MODIFY `idTrainingProgram` bigint(19) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
